      ...
      @if (presentation) {
        ...
        <div class="detail-section header">
          <div class="header-main">
            <h2 class="presentation-name">{{ presentation.name }}</h2>
            <span class="status-badge" [ngClass]="presentation.isActive ? 'active' : 'inactive'">
              <ng-icon [name]="presentation.isActive ? 'lucideCheckCircle2' : 'lucideXCircle'"></ng-icon>
              {{ presentation.isActive ? 'Activa' : 'Inactiva' }}
            </span>
          </div>
          <p class="presentation-code">ID de Sistema: #{{ presentation.id.split('-')[0].toUpperCase() }}</p>
        </div>
        ...
        <div class="detail-grid">
          <div class="kpi-card">
            ...
            <div class="kpi-info">
              ...
              <span class="kpi-value">{{ presentation.name }}</span>
            </div>
          </div>
          <div class="kpi-card">
            ...
            <div class="kpi-info">
              <span class="kpi-label">Descripción</span>
              <span class="kpi-value">{{ presentation.description || 'Sin descripción' }}</span>
            </div>
          </div>
        </div>
          ...
          <div class="info-list">
            <div class="info-item">
              ...
              <div class="item-content">
                ...
                <span class="item-text">{{ presentation.createdAt | date:'longDate' }}</span>
              </div>
            </div>
            ...
            <div class="info-item">
              ...
              <div class="item-content">
                ...
                <code class="uuid-text">{{ presentation.id }}</code>
              </div>
            </div>
          </div>
        </div>
